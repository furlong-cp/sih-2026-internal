...
export default function ApplicationsPage({
  ...
  return (
    <>
      ...
      `}</style>
      <div className="applications-page-container" style={styles.container}>
      {/* Top Banner */}
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "24px" }}>
          {filteredApps.map((app) => (
            <div key={app.id} style={styles.appCard}>
              ...
              {app.companyStats && (
                <div className="applications-stats-grid" style={styles.companyStatsGrid}>
